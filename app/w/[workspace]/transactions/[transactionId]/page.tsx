...
export default async function TransactionPage(
  props: PageProps<"/w/[workspace]/transactions/[transactionId]">,
) {
  const { transactionId } = await props.params;

  // The role decides what to *offer*; the actions decide what is allowed. Both
  // are needed and they are not the same check — see useCanEdit.
